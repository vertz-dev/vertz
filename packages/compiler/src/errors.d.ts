...
export declare function createDiagnostic(options: CreateDiagnosticOptions): Diagnostic;
export declare function createDiagnosticFromLocation(
...
export declare function filterBySeverity(
  diagnostics: readonly Diagnostic[],
  severity: DiagnosticSeverity,
): Diagnostic[];
export declare function mergeDiagnostics(
