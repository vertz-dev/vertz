...
export type DiagnosticCode =
  ...
  | 'VERTZ_SERVICE_DUPLICATE_NAME'
  | 'SERVICE_ACTION_MISSING_SCHEMA'
  ...
  | 'VERTZ_DEAD_CODE'
  | 'ENTITY_MISSING_ARGS'
  | 'ENTITY_NON_LITERAL_NAME'
  | 'ENTITY_INVALID_NAME'
  | 'ENTITY_DUPLICATE_NAME'
  | 'ENTITY_CONFIG_NOT_OBJECT'
  | 'ENTITY_MISSING_MODEL'
  | 'ENTITY_MODEL_UNRESOLVABLE'
  | 'ENTITY_ACTION_NAME_COLLISION'
  | 'ENTITY_ACTION_MISSING_SCHEMA'
  | 'ENTITY_ACTION_INVALID_METHOD'
  | 'ENTITY_UNKNOWN_ACCESS_OP'
  | 'ENTITY_UNRESOLVED_IMPORT'
  | 'ENTITY_ROUTE_COLLISION'
  | 'ENTITY_NO_ROUTES'
  | 'ENTITY_MODEL_NOT_REGISTERED'
  | 'ENTITY_EXPOSE_EMPTY_SELECT'
  | 'ENTITY_EXPOSE_NON_LITERAL'
  | 'ENTITY_EXPOSE_RELATION_UNRESOLVED'
