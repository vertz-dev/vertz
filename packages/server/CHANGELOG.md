...
- [#2993](https://github.com/vertz-dev/vertz/pull/2993) [`f426ce5`](https://github.com/vertz-dev/vertz/commit/f426ce57a57e7c23e84873250a94e9810ddcaeed) Thanks [@viniciusdacal](https://github.com/viniciusdacal)! - fix(server): narrow `rules.entitlement()` to the registered `Entitlement` union
