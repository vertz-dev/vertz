 ...
 */
export function categorizeFileChange(path) {
 ...
 */
export function getAffectedStages(category) {
  switch (category) {
    case 'domain':
    case 'module':
    case 'service':
 ...
 */
export function getStagesForChanges(changes) {
 ...
 */
export class PipelineWatcherImpl {
  handlers = new Map();
  watcher;
  config;
  isClosed = false;
 ...
 */
export function createPipelineWatcher(config) {
