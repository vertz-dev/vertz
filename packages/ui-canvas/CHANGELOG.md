...
- [`606b77a`](https://github.com/vertz-dev/vertz/commit/606b77adef3523eb9b5d47e53c9e2832860cd18d) Thanks [@viniciusdacal](https://github.com/viniciusdacal)! - Breaking changes to `@vertz/ui-canvas` to fix Phase 1 issues before Phase 2:
