---
title: Quickstart
description: 'Get up and running with Vertz in under 5 minutes'
---
...
<Steps>
  ...
  <Step title="Start the dev server">
    ...
    <Tip>
      If the [native runtime](/runtime) is installed, the dev server starts in ~5ms with built-in SSR and HMR — no extra setup required.
    </Tip>
