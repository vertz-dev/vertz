...
The typed test client gives you 100% type-safe access to your server's entities and services in tests — no path strings, no manual casting, no guessing. Tests use the [built-in test runner](/guides/testing-unit) (`vtz test`) with assertions from `@vertz/test` and the typed test client from `@vertz/testing`.
...
<CardGroup cols={2}>
  <Card title="Test Runner" icon="play" href="/guides/testing-unit">
