...
description: 'Vertz is a full-stack TypeScript framework — database ORM, API server, compiled UI, AI agents, custom runtime. Quick reference for AI code generation.'
---
