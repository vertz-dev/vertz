...
The runtime pauses before loading your entry module. Connect a debugger (Chrome DevTools or VS Code), and execution resumes automatically. The first statement of your entry module is where the debugger breaks.
...
```
Error: Inspector address already in use: 127.0.0.1:9229
```

Another process is using port 9229. Use a custom port:
