...
<Frame>
  <img
    src="/images/examples/task-manager-list.png"
    alt="Task Manager — task list view with status filters and pagination"
  />
</Frame>
...
<Card
  title="Source code"
  icon="github"
  href="https://github.com/vertz-dev/vertz/tree/main/examples/task-manager"
>
...
<Tree>
  ...
  <Tree.Folder name="e2e"></Tree.Folder>
