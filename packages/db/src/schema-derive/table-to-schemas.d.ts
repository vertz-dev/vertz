import type { ObjectSchema } from '@vertz/schema';
 ...
 * ```
 */
export declare function tableToSchemas<TColumns extends ColumnRecord>(
  table: TableDef<TColumns>,
): DerivedSchemas;
//# sourceMappingURL=table-to-schemas.d.ts.map
