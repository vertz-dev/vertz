 ...
 */
export function generateMigrationSql(changes, ctx) {
  const statements = [];
 ...
 */
export function generateRollbackSql(changes, ctx) {
  const reverseChanges = changes
    ...
    .map((change) => {
      switch (change.type) {
        case 'table_added':
          return { ...change, type: 'table_removed' };
        case 'table_removed':
          return { ...change, type: 'table_added' };
        case 'column_added':
          return { ...change, type: 'column_removed' };
        case 'column_removed':
          return { ...change, type: 'column_added' };
        case 'column_altered':
          return {
            ...change,
        ...
        case 'index_added':
          return { ...change, type: 'index_removed' };
        case 'index_removed':
          return { ...change, type: 'index_added' };
        case 'enum_added':
          return { ...change, type: 'enum_removed' };
        case 'enum_removed':
          return { ...change, type: 'enum_added' };
        case 'enum_altered':
          return {
            ...change,
