...
describe('d.entry() types', () => {
  it('returns TableEntry with empty relations when called with table only', () => {
    ...
    expectTypeOf(entry.table).toEqualTypeOf();
  ...
  it('returns TableEntry with typed relations when called with table and relations', () => {
    ...
    expectTypeOf(entry).toMatchTypeOf();
    expectTypeOf(entry.table).toEqualTypeOf();
    expectTypeOf(entry.relations.author._type).toEqualTypeOf();
    expectTypeOf(entry.relations.comments._type).toEqualTypeOf();
  });
  it('entry result satisfies Record<string, TableEntry>', () => {
    ...
    expectTypeOf(tables.users).toMatchTypeOf();
    expectTypeOf(tables.posts).toMatchTypeOf();
  });
...
describe('createRegistry() types', () => {
  ...
  it('output type matches Record<string, TableEntry>', () => {
    ...
    expectTypeOf(tables).toMatchTypeOf();
  });
  it('preserves specific table and relation types in output', () => {
    ...
    expectTypeOf(tables.users.table).toEqualTypeOf();
    expectTypeOf(tables.posts.table).toEqualTypeOf();
    expectTypeOf(tables.comments.table).toEqualTypeOf();
    // Relation types are preserved
    expectTypeOf(tables.posts.relations.author).toMatchTypeOf();
  });
...
//# sourceMappingURL=registry.test-d.js.map
