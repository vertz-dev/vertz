 ...
 */
// eslint-disable-next-line @typescript-eslint/no-empty-object-type -- {} is the correct identity for type-level intersections
type EmptyProvides = {};
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- variance boundary — must accept any NamedMiddlewareDef generics
export type AccumulateProvides<T extends readonly NamedMiddlewareDef<any, any>[]> =
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- recursive type requires same variance boundary
