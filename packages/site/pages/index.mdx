...
<Steps>
  ...
  <Step title="Build the UI" icon="monitor">
...
<CardGroup cols={2}>
  <Card title="Types flow everywhere" icon="arrow-left-right">
  ...
  <Card title="Compiler-driven reactivity" icon="cpu">
...
<CardGroup cols={2}>
  ...
  <Card title="UI Components" icon="puzzle" href="/guides/ui/components">
