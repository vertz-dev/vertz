...
<CardGroup cols={2}>
  <Card title="Components" icon="puzzle" href="/guides/ui/components">
    Props, children, conditionals, lists, and component patterns.
  </Card>
  <Card title="Reactivity" icon="zap" href="/guides/ui/reactivity">
  ...
  <Card title="Data Fetching" icon="cloud-download" href="/guides/ui/data-fetching">
