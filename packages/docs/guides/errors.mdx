...
<Warning>`unwrap` throws on error. Use it only in test setup, scripts, or contexts where you're certain the result is `Ok`. In application code, always handle both branches.</Warning>
