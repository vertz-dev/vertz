...
### 1. Provide the access context

Wrap your app with `AccessContext.Provider`. Use `createAccessProvider()` to bootstrap from the SSR-injected access set:
...
### 2. Inject the access set during SSR
