...
Every feature must be demonstrable. Not "it passes tests" — someone can *see it working*. This forces us to think about the real experience, not just the internal implementation.
