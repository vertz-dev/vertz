/**
 * Built-in SVG icons for common OAuth providers.
 * Returns inline SVG strings — no external requests, works in SSR.
 */
...
const icons: Record<string, (size: number) => string> = {
  ...
  microsoft: (size) =>
    `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24"><rect fill="#F25022" x="1" y="1" width="10" height="10"/><rect fill="#7FBA00" x="13" y="1" width="10" height="10"/><rect fill="#00A4EF" x="1" y="13" width="10" height="10"/><rect fill="#FFB900" x="13" y="13" width="10" height="10"/></svg>`,
...
/** Generic fallback icon — a key icon for unknown providers. */
 ...
 */
export function getProviderIcon(providerId: string, size: number): string {
