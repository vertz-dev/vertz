...
export const HEIGHT_AXIS_PROPERTIES = new Set(['h', 'min-h', 'max-h']);
/** Known color token namespaces -- values that resolve to CSS custom properties. */
export const COLOR_NAMESPACES = new Set([
  'primary',
  'secondary',
  'accent',
  'background',
...
export const PSEUDO_PREFIXES = new Set([
  'hover',
  'focus',
  'focus-visible',
  'active',
...
//# sourceMappingURL=token-tables.js.map
