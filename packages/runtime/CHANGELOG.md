...
- [#2940](https://github.com/vertz-dev/vertz/pull/2940) [`7106c64`](https://github.com/vertz-dev/vertz/commit/7106c64ce5c246305b90a898596c64b2191ad1fa) Thanks [@viniciusdacal](https://github.com/viniciusdacal)! - fix(vtz): invalidate dependents' cache when a source file fails to compile
...
- [#2934](https://github.com/vertz-dev/vertz/pull/2934) [`0832118`](https://github.com/vertz-dev/vertz/commit/083211867a5938b2ead7215269f0ee1307d174db) Thanks [@viniciusdacal](https://github.com/viniciusdacal)! - fix(compiler): field-selection analyzer handles reduce/flatMap, loops/try/switch, and scope shadowing
...
- [#2933](https://github.com/vertz-dev/vertz/pull/2933) [`d49362d`](https://github.com/vertz-dev/vertz/commit/d49362d72030b961b27e0c1d75d6d363b1306415) Thanks [@viniciusdacal](https://github.com/viniciusdacal)! - fix(vtz): route splitting no longer silently drops non-bare-identifier route components
