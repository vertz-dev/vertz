...
- [#2883](https://github.com/vertz-dev/vertz/pull/2883) [`8a9546d`](https://github.com/vertz-dev/vertz/commit/8a9546d4725f5aa1572ab0dbf96e20abb6063413) Thanks [@viniciusdacal](https://github.com/viniciusdacal)! - fix(compiler): recognize regex literals in `strip_comments` so a backtick inside a regex body doesn't eat the rest of the file
