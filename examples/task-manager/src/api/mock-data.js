...
export const taskApi = {
    create: Object.assign((body) => createTask(body), {
        url: '/api/tasks',
        method: 'POST',
    }),
    update: (id) => Object.assign((body) => updateTask(id, body), {
        url: `/api/tasks/${id}`,
        method: 'PATCH',
    }),
    delete: (id) => Object.assign(() => deleteTask(id), { url: `/api/tasks/${id}`, method: 'DELETE' }),
};
