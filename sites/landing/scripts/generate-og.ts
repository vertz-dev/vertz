...
// Full wordmark from vertz-logo.tsx (viewBox 0 0 689 272)
const logoSvg = `<svg viewBox="0 0 689 272" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      children: [
        // Background glow (blue)
        {
          ...
          props: {
            style: {
              ...
              height: '600px',
              borderRadius: '50%',
              background: 'radial-gradient(circle, rgba(61,148,255,0.12) 0%, transparent 70%)',
            },
          },
        },
        ...
        // Subtitle
        {
          ...
          props: {
            ...
            children: 'Define your schema once. Everything else is derived. Zero config.',
          },
        },
