...
# Publish all public source packages via `bun publish` (resolves workspace:* protocols).
# Runtime binary packages (@vertz/runtime) are published from the vertz-dev/vtz repo.
